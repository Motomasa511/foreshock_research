      subroutine run_etas(xout, gout, fout, aicout)
Cf2py intent(out) xout, gout, fout, aicout
      implicit real*8 (a-h,o-z)
      parameter(npara=5)
      dimension xout(npara), gout(npara)
      common /param/ xini(npara), n
      common /results/ fval, aicval
c-----------------------------------------------------------------------
...
c***********************************************************************
      ...
      common t,nn,mm,iappr,nfunct
      common/param/xini(npara),n
      common/param/g(npara)
      common /ddd/ f,aic2
      common /kkxy/kkx,kky,kkt
      dimension x(npara)
      common /results/ fval, aicval
      double precision fval, aicval
      common /gradres/ gres(5)
      double precision gres
c
      do 10 i=1,nn
...
c
      do 30 ii=1,1 
c
      if(nfunct.eq.4) call davidn(x,g,n,4,func4)
c
      if(nfunct.eq.9) call davidn(x,g,n,9,func9)
c
   30 continue
c
      do 80 i=1,n
...
c***********************************************************************
      subroutine  davidn( x,g,n,ihes,funct )
c
